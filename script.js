...
function update() {
  ...
  // Draw score in top-left corner, ensuring it is on top
  ctx.font = "20px Arial";
  ctx.fillStyle = "white";
  ctx.fillText("Score: " + score, 10, 30); // Display score on top
}
...
document
  .getElementById("left")
  .addEventListener("click", () => handleButton("left"));
document
  .getElementById("up")
  .addEventListener("click", () => handleButton("up"));
document
  .getElementById("right")
  .addEventListener("click", () => handleButton("right"));
document
  .getElementById("down")
  .addEventListener("click", () => handleButton("down"));
